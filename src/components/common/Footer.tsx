        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/" className="text-green-200 hover:text-yellow-300 transition-colors">
                  {t('nav.home')}
                </Link>
              </li>
              <li>
                <Link to="/price-comparison" className="text-green-200 hover:text-yellow-300 transition-colors">
                  {t('nav.price_comparison')}
                </Link>
              </li>
              <li>
                <Link to="/msp-information" className="text-green-200 hover:text-yellow-300 transition-colors">
                  {t('nav.msp_information')}
                </Link>
              </li>
              <li>
                <Link to="/procurement-centers" className="text-green-200 hover:text-yellow-300 transition-colors">
                  {t('nav.procurement_centers')}
                </Link>
              </li>
              <li>
                <Link to="/selling-deadlines" className="text-green-200 hover:text-yellow-300 transition-colors">
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-3">
              <li className="flex items-start space-x-3">
                ...
                <span className="text-green-200">Pune, Maharashtra, India</span>
              </li>
              <li className="flex items-center space-x-3">
                <Phone size={20} className="text-yellow-400 flex-shrink-0" />
                <span className="text-green-200">+91 9561706020</span>
              </li>
              <li className="flex items-center space-x-3">
                <Mail size={20} className="text-yellow-400 flex-shrink-0" />
                <span className="text-green-200">infokisandhan@gmail.com</span>
              </li>
            </ul>
          </div>
        </div>
